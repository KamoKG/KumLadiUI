...
var AdmininterfaceComponent = (function () {
    ...
    AdmininterfaceComponent.prototype.ad_get_mileStones = function () {
        var _this = this;
    ...
    // "data":[{"name":"Khaya","surname":"Lolly","userID":"u12345678","posts":1,"upVotes":0,"downVotes":0,"points":0}
    AdmininterfaceComponent.prototype.create_mileStone = function () {
        var p1 = document.getElementById("id_milestoneName").value;
        var p2 = document.getElementById("id_description").value;
        var p3 = document.getElementById("id_reward").value;
        var p4 = document.getElementById("id_data").value;
        var p = { milestoneName: p1, description: p2, reward: p3, data: p4 };
        console.log(p);
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.refresh_dashboard = function () {
        ...
        if (this.idForMe != "" && sessionStorage.getItem("sessionID")) {
            ...
            this.x_setMessage(this.idForMe);
    ...
    AppComponent.prototype.x_setMessage = function (choosenId) {
        ...
        this._mediatorService.getContent(choosenId)
            ...
            if (_this.mess_Post.status == false) {
                _this.idForMe = "";
                _this.mess_Post = null;
            }
        })
            .catch(function (err) { return console.log(err); });
    ...
    AppComponent.prototype.loadImage = function () {
        // if ((<HTMLInputElement>document.getElementById("phody")))
    ...
    AppComponent.prototype.removePost = function (x) {
        ...
        this._mediatorService.removePost(p)
            .then(function (garbage) { _this.garbage = garbage; _this.idForMe = ""; _this.mess_Post = null; _this.refresh_dashboard(); })
            .catch(function (err) { return console.log(err); });
    };
...
var GroupsComponent = (function () {
    ...
    GroupsComponent.prototype.exitGroup = function () {
        var x = { groupName: this.groupName, userID: sessionStorage.getItem("sessionID") };
        this._kontrolService.exitGroup(x)
            .then(function (status) { })
            .catch(function (err) { return console.log(err); });
    };
...
var KontrollerService = (function () {
    ...
    KontrollerService.prototype.rewardUser = function (p) {
    ...
    KontrollerService.prototype.exitGroup = function (p) {
    ...
    KontrollerService.prototype.getTotalLikes = function (x) {
    ...
    KontrollerService.prototype.getMilestones = function () {
...
var ReportsComponent = (function () {
    function ReportsComponent(_kontrolService, _mediatorService) {
        ...
        this.mileStones = [];
        this.leader_selected_module = "Select Module";
        this.tot_likes = 0;
        this.data = {
    ...
    ReportsComponent.prototype.rep_get_mileStones = function () {
        var _this = this;
        this._kontrolService.getMilestones()
            .then(function (mileStones) { _this.mileStones = mileStones; _this.getLikes(); })
            .catch(function (err) { return console.log(err); });
    };
    ReportsComponent.prototype.getLikes = function () {
        var _this = this;
        // this.chechIfAnyMilestonesCompleted();
        this._kontrolService.getTotalLikes(sessionStorage.getItem("sessionID"))
            .then(function (tot_likes) { _this.tot_likes = tot_likes; _this.chechIfAnyMilestonesCompleted(); })
            .catch(function (err) { return console.log(err); });
    };
    ReportsComponent.prototype.chechIfAnyMilestonesCompleted = function () {
        this.mileStonesCompleted = [];
        this.mileStonesNotCompleted = [];
    ...
    ReportsComponent.prototype.rewarduser = function (x, y) {
    ...
    ReportsComponent.prototype.leader_seleceted_newModule = function (x) {
